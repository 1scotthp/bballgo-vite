...
const TeamInfoPage = () => {
  ...
  const selectedTeam = teams.find(
    (team) => team.teamAbbreviation === selectedTeamAbbr
  );
      ...
      {selectedTeam && (
        <div>
          ...
          <table style={{ width: "100%", borderCollapse: "collapse" }}>
            ...
            <tbody>
              {selectedTeam.roster
                .sort((a, b) => b.stats.mins - a.stats.mins)
                .map((player) => {
                  ...
                  return (
                    <tr key={player.id}>
                      ...
                      <td style={{ border: "1px solid #ddd", padding: "8px" }}>
                        {(player.stats.mins / 87 / 4).toFixed(1)}
                      </td>
                      <td style={{ border: "1px solid #ddd", padding: "8px" }}>
                      ...
                      <td style={{ border: "1px solid #ddd", padding: "8px" }}>
                        {(
                          player.stats.twoPointShotsTaken * per36Multiplier
                        ).toFixed(1)}
                      </td>
                      <td style={{ border: "1px solid #ddd", padding: "8px" }}>
                        {(
                          player.stats.twoPointShotsMade * per36Multiplier
                        ).toFixed(1)}
                      </td>
                      <td style={{ border: "1px solid #ddd", padding: "8px" }}>
                        {(
                      ...
                      <td style={{ border: "1px solid #ddd", padding: "8px" }}>
                        {(
                          player.stats.threePointShotsMade * per36Multiplier
                        ).toFixed(1)}
                      </td>
                      <td style={{ border: "1px solid #ddd", padding: "8px" }}>
                        {(
                          player.stats.freeThrowsTaken * per36Multiplier
                        ).toFixed(1)}
                      </td>
                      <td style={{ border: "1px solid #ddd", padding: "8px" }}>
                        {(
                          player.stats.freeThrowsMade * per36Multiplier
                        ).toFixed(1)}
                      </td>
                      <td style={{ border: "1px solid #ddd", padding: "8px" }}>
                        {(
